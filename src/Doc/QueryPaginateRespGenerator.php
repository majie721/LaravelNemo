...
class QueryPaginateRespGenerator extends BaseCodeGenerator
{
    /** @var string  */
    ...
    public function generate():FileStore{
        ...
        $headerLines[] = "";
        $useLines[] = "use LaravelNemo\Library\PaginateResponse;";
        ...
        $lines[] = "";
        $lines[] = "class {$class} extends PaginateResponse";
        $lines[] = "{";
